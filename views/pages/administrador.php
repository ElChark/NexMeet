...
<head>
    ...
    <title>NexMeet - Panel de Administrador</title>
                                ...
                                <td>
                                    <div style="display: flex; align-items: center; gap: 10px;">
                                        <div style="width: 36px; height: 36px; border-radius: 50%; overflow: hidden;">
                                            <img src="https://via.placeholder.com/36/ff5a5f/ffffff?text=AL" alt="Avatar" style="width: 100%; height: 100%; object-fit: cover;">
                                        </div>
                                        <div>
                                            <div style="font-weight: 500;">Ana López</div>
                                            <div style="font-size: 12px; color: var(--medium-gray);">@analopez</div>
                                        </div>
                                    </div>
                                </td>
