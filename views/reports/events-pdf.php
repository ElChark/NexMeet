...
<body>
    <h1>Eventos publicados en NexMeet</h1>
                ...
                <tr>
                    <td>
                        <div style="display: flex; align-items: center; gap: 10px;">
                            <div>
                                <div style="font-weight: 500;"><?php echo $evento['titulo'] ?></div>
                            </div>
                        </div>
                    </td>
                    <td><?php echo $evento['descripcion_evento'] ?></td>
                    <td><?php echo $evento['fecha_publicacion'] ?></td>
                    <td><?php echo $evento['fecha_evento'] ?></td>
                    <td><?php echo $evento['nombreLugar'] ?></td>
                    <td><?php echo $evento['categoria'] ?></td>
                    <td><?php echo $evento['reaccion'] ?></td>
                </tr>
            <?php } ?>
